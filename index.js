...
* (Scriptnya CALYA KIEZA cuy).
*/
const BotName = 'KezaBot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/_calyza/'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6285601459079'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = '~'; // OFFICIAL GRUP LU 1
const grupch2 = 'Gamer Legends (cari sendiri di YT)'; // OFFICIAL YT LU
